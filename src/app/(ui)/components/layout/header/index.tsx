...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed h-20 top-0  z-50 w-full transition-all ${sticky ? "shadow-lg dark:shadow-darkmd bg-white dark:bg-semidark" : "shadow-none bg-herobg/80"}`}
    >
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4 py-5">
        <Logo />
