...
import { toTitleCase } from "../hotel-details";
        ...
        <div className="flex justify-center items-center bg-light">
            <div className="lg:max-w-screen-xl md:max-w-screen-md mx-auto container px-4">
                <h2 className="text-xl">
                    Similar Hotel Properties to {title} at {loc}
                </h2>
                            ...
                            <div key={index} className="p-4">
                                ...
                                >
                                    ...
                                    <div className="p-4 space-y-3">
                                        ...
                                        <button onClick={() => router.push(`/hotel-list/${item.location.toLowerCase()}/${item.name.replace(/\s+/g, "-").toLowerCase()}`)} className="w-full mt-2 bg-primary text-white py-2 rounded-md hover:bg-blue-700 transition">
                                            Book Your Room
                                        </button>
                                    </div>
                                </div>
