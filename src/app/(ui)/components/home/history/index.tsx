...
export default function History() {
  return (
    <section className="history-bg">
      <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto grid grid-cols-1 lg:grid-cols-12 ">
        <div
          className="col-span-1 lg:col-span-7 5xl:col-span-8 px-4"
          data-aos="fade-right"
        >
          <h2 className="text-4xl text-midnight_text mb-8">
            Inspired by Comfort{" "}
            <span className="text-skyBlue">Designed for You</span>
          </h2>
