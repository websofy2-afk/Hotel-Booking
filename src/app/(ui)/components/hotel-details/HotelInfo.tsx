...
export default function HotelInfo({ room, roomName, price, noOfRooms }: { room: any, roomName: string, price: number, noOfRooms: number }) {
    const scrollToRooms = () => {
            ...
            <div className="border border-border shadow-sm shadow-skyBlue rounded-xl p-5 sticky">
                ...
                <div className="flex items-center gap-2">
                    <p className="flex items-center gap-2 text-sm border-r-[1px] border-gray">
                        <IoPeople className="text-gray" /> <span className="text-midnight_text  mr-1">3 Guests</span>
                    </p>
