    ...
    <section className="flex justify-center bg-light items-center">
      <div className="lg:max-w-screen-xl md:max-w-screen-md mx-auto container px-4">
        ...
        >
          <button
            onClick={prev}
            className="p-3 rounded-full border hover:bg-gray-100 dark:hover:bg-gray-700 transition"
          >
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-xl font-semibold text-center text-midnight_text dark:text-white">
              {reviews[index].name}
            </p>
            <p className="text-gray dark:text-gray-300 text-center mt-3 text-lg leading-relaxed max-w-xl">
              {reviews[index].text}
            </p>
