export const QuickStart = () => {
  return (
    <div className="pb-10 md:scroll-m-[180px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-darkborder">
        <h6 className="dark:text-white text-lg font-medium">1. Requirements</h6>
        <p className="text-base font-medium text-midnight_text dark:text-gray">
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-darkborder">
        ...
        <div className="py-4 px-3 rounded-md bg-black">
          ...
          <p className="text-sm text-lightgray mt-2">npm install</p>
        </div>
        <h6 className="mt-4 mb-2 dark:text-white text-dark font-medium text-base">
          1) Install with yarn:
        </h6>
        <div className="py-4 px-3 rounded-md bg-black">
          ...
          <p className="text-sm text-lightgray mt-2">yarn install</p>
        </div>
      </div>
      <div className="p-6 rounded-md border mt-6 border-border dark:border-darkborder">
        <h6 className="dark:text-white text-lg font-medium">3. Start</h6>
        <p className="text-base font-medium text-midnight_text dark:text-gray mb-4">
          Once npm install is done now you an run the app.
        </p>

        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-lightgray">npm run dev or yarn run dev</p>
        </div>
        <p className="text-base font-medium text-midnight_text dark:text-gray my-4">
          This command will start a local webserver{" "}
          <span className="dark:text-white">http://localhost:3000:</span>
        </p>
        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-lightgray">
            {"> property_project@1.0.1 dev"}
          </p>
          <p className="text-sm text-lightgray mt-1">{"> next dev"}</p>
          <p className="text-sm text-lightgray mt-6">{"-Next.js 15.1.1"}</p>
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-darkborder">
        ...
        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-lightgray">npm run build or yarn build</p>
        </div>
        <p className="text-base font-medium text-midnight_text dark:text-gray mt-6">
