      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
        {
          currentData.map((item) => (
            <div key={item._id} className="border-border shadow-md shadow-skyBlue/20 outline-none h-full  border border-gray-200 rounded-xl">
              <Image
                src={item.image}
                alt=" grid"
                className="w-full h-64 border rounded-t-xl"
                width={500}
                height={500}
              />
              <div className="m-3">
                <h3 className="text-midnight_text">{item.title}</h3>
