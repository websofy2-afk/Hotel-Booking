...
export default function RoomCategoryModel({ mode, onClose, onSave, initialData }: any) {
    ...
    <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-[9999] bg-black/60" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <h2 className="text-xl font-semibold">{mode === "edit" ? "Update" : mode === "delete" ? "Delete" : "Add"} Room Category</h2>
          <button
            onClick={onClose}
